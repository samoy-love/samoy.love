...
Офлайн-PWA: схема рисуется на Canvas по предрассчитанным координатам, маршрут считается прямо на клиенте в Web Worker. Ни одного сетевого запроса после установки.
